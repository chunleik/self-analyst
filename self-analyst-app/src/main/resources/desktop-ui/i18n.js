...
var MESSAGES = {
  ...
  "file.settingsSubtitle": { zh: "按目录管理监控范围，保存后立即生效", en: "Manage watched folders individually; changes apply immediately" },
  "file.enableCollection": { zh: "启用文件采集", en: "Enable file collection" },
  "file.enableCollectionHint": { zh: "关闭后保留目录配置，但暂停监控和索引。", en: "Keep folder settings while pausing watching and indexing." },
  ...
  "file.liveApplyNote": { zh: "保存后无需重启，新的监控目录会立即生效。", en: "No restart is needed; watched folders take effect immediately after saving." },
