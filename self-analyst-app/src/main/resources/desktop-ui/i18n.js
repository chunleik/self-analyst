...
var MESSAGES = {
  ...
  // ── Config ──
  "config.modalTitle": { zh: "配置", en: "Settings" },
  "config.loading": { zh: "加载配置中...", en: "Loading configuration..." },
  "config.allConfigurableKeys": { zh: "全部可配置项", en: "All configurable keys" },
  "config.noConfigurableKeys": { zh: "无可配置项", en: "No configurable keys" },
  "config.configured": { zh: "已配置", en: "Configured" },
  "config.insert": { zh: "插入", en: "Insert" },
  "config.historyVersions": { zh: "历史版本", en: "Version history" },
  ...
  "config.connectOk": { zh: "连接成功", en: "Connection succeeded" },
  "config.connectFailed": { zh: "连接失败: {msg}", en: "Connection failed: {msg}" },
  "config.testFailed": { zh: "测试失败: {msg}", en: "Test failed: {msg}" },
  ...
  "config.historyLoadFailed": { zh: "历史版本载入失败", en: "Failed to load version history" },
  "config.historyEmpty": {
    zh: "暂无历史版本（保存后自动生成）",
    en: "No version history yet (created automatically after saving)",
  },
  "config.summaryGenerating": { zh: "（摘要生成中…）", en: "(summary generating…)" },
  "config.legacyPropertiesViewOnly": { zh: "旧格式（properties），仅可查看", en: "Legacy format (properties), view only" },
  "config.legacyPropertiesSwitchDisabled": { zh: "旧格式配置不可切换", en: "Legacy configuration cannot be switched" },
  "config.collapse": { zh: "收起", en: "Collapse" },
  "config.view": { zh: "查看", en: "View" },
  "config.switch": { zh: "切换", en: "Switch" },
  "config.loadVersionFailed": { zh: "载入版本失败: {msg}", en: "Failed to load version: {msg}" },
  "config.versionLoaded": { zh: "已载入版本「{name}」，保存后生效", en: 'Loaded version "{name}"; it takes effect after saving' },
  "config.switchVersionFailed": { zh: "切换版本失败: {msg}", en: "Failed to switch version: {msg}" },
