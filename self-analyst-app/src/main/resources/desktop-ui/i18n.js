...
var MESSAGES = {
  ...
  "config.runtimeTitle": { zh: "配置生效状态", en: "Configuration status" },
  "config.runtime.applied": { zh: "已生效", en: "Applied" },
  "config.runtime.draining": { zh: "新任务已生效，当前回答继续使用原配置", en: "Applied to new work; existing work uses its original configuration" },
  "config.runtime.restart_required": { zh: "需要重启后端", en: "Backend restart required" },
  "config.runtime.unavailable": { zh: "LLM 不可用，请检查模型配置", en: "LLM unavailable; check model configuration" },
  "config.runtimeLoadFailed": { zh: "暂时无法读取生效状态，可重新打开配置查看", en: "Unable to load runtime status. Reopen configuration to retry." },
  "config.sourcesTitle": { zh: "查看大模型配置与来源", en: "Model configuration and sources" },
  "config.key": { zh: "配置项", en: "Setting" },
  "config.savedValue": { zh: "已保存的有效值", en: "Saved effective value" },
  "config.runningValue": { zh: "新任务使用的值", en: "Value for new work" },
  "config.source": { zh: "来源", en: "Source" },
  "config.source.toml": { zh: "用户 TOML", en: "User TOML" },
  "config.source.environment": { zh: "环境变量", en: "Environment" },
  "config.source.jvm": { zh: "JVM 参数", en: "JVM property" },
  "config.source.default": { zh: "默认值", en: "Default" },
  "config.source.inherited": { zh: "继承配置", en: "Inherited" },
